...
class DependentsController < ApplicationController
  ...
  def ensure_current_user_is_creator
    return unless @dependent.user_id != current_user.id
  ...
  def dependent_params
    params.require(:dependent).permit(:user_id, :image, :address, :relationship, :first_name, :last_name,
                                      :date_of_birth, :immigration_status, :country_of_citizenship, :contact_info, :notes)
  end
end
